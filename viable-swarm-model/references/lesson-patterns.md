...
# Lesson Patterns Report -- 2026-06-06 09:38 UTC

## Header

| Metric | Value |
|---|---|
| Date | 2026-06-06 09:38 UTC |
| Builds scanned | 26 |
| Total lessons | 219 |
...
| docker / dev / null | 2 | FB25-20260602, FB26-20260603 | Removed invalid COPY instruction; nginx default config is sufficient for this bu... | Consider consolidating prevention rule for 'docker / dev / null' |
